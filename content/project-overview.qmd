...
![The primary geographic scope — the Margaree River watershed — located in the Fraser River system.](images/geo-scope-marg.png){#fig-geoscope}
...
The following table highlights structure types threatening anadromous salmonids in the watershed. The results of this assessment were used to inform the subsequent planning steps; and identify knowledge gaps where there are limited spatial data to inform the assessment for a specific structure type. 
...
df = pd.DataFrame({"Barrier Types":["Small Dams (<5m Height)","Natural Barriers","Road Stream Crossings"],
                   "Extent":["Low", "Medium", "High"],
                   "Severity":["Low", "Low","Very High"],
                   "Irreversibility":["Medium","Medium","Low"],
                   "Overall Threat Rating:":["Low","Low","High"]
