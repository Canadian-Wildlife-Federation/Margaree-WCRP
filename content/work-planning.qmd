...
#| label: table-2
#| tbl-cap: "Table 2: Implementation plan for 2025 to close knowledge gaps and advance barrier rehabilitation to improve connectivity for Atlantic Salmon in the Margaree. Steps to incorporate field data, update models, and revise this WCRP are also included."
#| warning: false
#| echo: false
